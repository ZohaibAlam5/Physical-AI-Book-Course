...
def create_embedding_for_content(text: str, model_name: str = "all-MiniLM-L6-v2") -> List[float]:
    """
...
def create_embeddings_for_contents(texts: List[str], model_name: str = "all-MiniLM-L6-v2", batch_size: int = 32) -> List[List[float]]:
    """
